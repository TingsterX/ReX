...
#' 
#' @param dist [n x n] a distance matrix for n subjects.
#' @param sID [n] a vector containing the subject ID for each subject.
#' @param method 1 (default) or 2, 1: count identification for each subject. 2: count identification for each observation)
#' @return FP [n] a vector containing fringerprinting (identification rate) range 0-1
#' @author Ting Xu
#' @export
